                ...
                tabs: [
                        ...
                        components: [...new DesignerToolbarSettings()
                            ...
                            .addSettingsInputRow({
                                ...
                                inputs: [
                                    {
                                        type: 'radio',
                                        id: 'source-s4gmBg31azZC0UjZjpfTm',
                                        propertyName: 'imageSource',
                                        label: 'Image Source',
                                        buttonGroupOptions: [{ value: 'url', title: 'URL' }, { value: 'upload', title: 'uploader' }],
                                        jsSetting: true,
                                    },
                                    {
                                        type: 'text',
                                        id: 'url-s4gmBg31azZC0UjZjpfTm',
                                        propertyName: 'url',
                                        label: 'URL',
                                        jsSetting: true,
                                        hidden: 'data?.imageSource !== "url";' as any,
                                    },
                                    {
                                        type: 'imageUploader',
                                        id: 'uploader-s4gmBg31azZC0UjZjpfTm',
                                        propertyName: 'uploadedFile',
                                        label: 'Upload Image',
                                        jsSetting: true,
                                        hidden: 'data?.imageSource !== "uploader;' as any,
                                    }
                                ],
                                readOnly: { _code: 'return  getSettingValue(data?.readOnly);', _mode: 'code', _value: false } as any,
                            })
                            .addSettingsInputRow({
                                ...
                                inputs: [
                                    {
                                        type: 'switch',
                                        id: 'annotation-s4gmBg31azZC0UjZjpfTm',
                                        propertyName: 'isOnImage',
                                        label: 'Annotation on Image',
                                        size: 'small',
                                        tooltip: 'This property allows for annotation decriptions to be either on top of the image or on the side of the image.',
                                        jsSetting: true,
                                    },
                                    {
                                        type: 'switch',
                                        id: 'allow-add-s4gmBg31azZC0UjZjpfTm',
                                        propertyName: 'allowAddingNotes',
                                        label: 'Allow Adding Notes',
                                        tooltip: 'This property allows notes/ comments to be added for each annotation or just have number as annotations.',
                                        jsSetting: true,
                                    },
                                ],
                            })
                    ...
                    },
                    {
                        ...
                        components: [...new DesignerToolbarSettings()
                            ...
                            .addSettingsInputRow({
                                id: 'number-points-s4gmBg31azZC0UjZjpfTm',
                                parentId: 's4gmBg31azZC0UjZjpfTm',
                                inputs: [
                                    {
                                        type: 'number',
                                        id: 'min-s4gmBg31azZC0UjZjpfTm',
                                        propertyName: 'minPoints',
                                        label: 'Min Number of Points',
                                        tooltip: 'This property denote least number of marks/points an image must have.',
                                        jsSetting: true,
                                    },
                                    {
                                        type: 'number',
                                        id: 'max-s4gmBg31azZC0UjZjpfTm',
                                        propertyName: 'maxPoints',
                                        label: 'Max Number of Points',
                                        tooltip: 'This property denote at most possible marks/points an image could have.',
                                        jsSetting: true,
                                    },
                                ],
                                readOnly: { _code: 'return  getSettingValue(data?.readOnly);', _mode: 'code', _value: false } as any,
